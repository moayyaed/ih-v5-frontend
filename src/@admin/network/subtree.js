...
core.network.request('subtree_form', (send, context) => {
  send([
    { method: 'getmeta', type: 'form', id: context.params.component, navnodeid: context.params.navnodeid, nodeid: context.params.curent },
    { method: 'get', type: 'form', id: context.params.component, navnodeid: context.params.navnodeid, nodeid: context.params.curent },
  ]);
})
