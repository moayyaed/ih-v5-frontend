...
export class CircleSlider extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.updateSliderFromProps = valueFromProps => {
      const {
        stepSize
      } = this.props;
    ...
    this.getStepsArray = (min, stepSize) => {
      const stepArray = [];
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("svg", {
      ...
      cx: center,
      cy: center
    }), isAllGradientColorsAvailable && /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("linearGradient", {
      id: "gradient",
      x1: "0",
      x2: "0",
      y1: "0",
      ...
      d: this.getPath()
    }), shadow && /*#__PURE__*/React.createElement("filter", {
      id: "dropShadow",
      ...
      cx: x,
      cy: y
    }), showTooltip && /*#__PURE__*/React.createElement("text", {
      x: size / 2,
