...
export function getTranslation({x, y, scale}: ControlPosition, positionOffset: PositionOffsetControlPosition, unitSuffix: string): string {
  let translation = `translate(${x}${unitSuffix},${y}${unitSuffix})`;
  if (scale) {
    translation = `translate(${x}${unitSuffix},${y}${unitSuffix}) scale(${scale})`;
  }
  if (positionOffset) {
    ...
    if (scale) {
      translation = `translate(${defaultX}, ${defaultY}) scale(${scale})` + translation;
    }
  }
  return translation;
}
