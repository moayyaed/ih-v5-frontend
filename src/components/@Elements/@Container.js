...
class Container extends PureComponent {
  ...
  handleRender = (id, item) => {
    ...
    return (
      ...
      >
        {elemets(this.props.container.elements[id].type, { id, containerId: this.props.item.containerId.id, layoutId: this.props.layoutId, mode: this.props.mode, item: this.props.container.elements[id] })}
      </div>
    )
  }
