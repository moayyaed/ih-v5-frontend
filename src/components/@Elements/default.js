...
const TEXT = {
  ...
  textBold: { value: 0 },
  textItalic: { value: 0 },
  textFontFamily: { value: { id: 'Arial' } },
  textAlignH: { value: { id: 'center' } },
  textAlignV: { value: { id: 'center' } },
  textRotate: { value: 0 },
...
const INPUT = {
  ...
  endAdornment: { value: ''},
  size: { value: { id: 'medium' }},
  fullWidth: { value: false },
  fullHeight: { value: false },
  inputMode: { value: { id: 'number' }},
  saveMode: { value: { id: 'outfocus' }},
  textSize: { value: 16 },
