  ...
  handleContextMenuElement = (e, elementId) => {
    ...
    const scheme = {
      main: [
        ...
        { id: '17', type: 'divider' },
        { id: '18', check: 'isTemplate', title: core.lang({ lang: 'edit_template'}), click: this.handleClickEditTemplate },
      ]
    }
  ...
  handleAutoLinkElement = (data, context) => {
    if (data === ':exit:') {
      ...
      if (context.component.id) {
        ...
        core.actions.pdf.data(this.props.id, this.props.prop, { elements });
        this.props.save();
      }
    }
  }
