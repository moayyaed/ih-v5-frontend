...
class Sheet extends Component {
  ...
  handleContextMenuElement = (e, elementId) => {
    ...
    const listElemnts = [
      ...
      { id: '14', title: 'Report', click: () => this.handleAddElement(e, 'report') },
     // { id: '14', title: 'Schedule', click: () => this.handleAddElement(e, 'schedule') },
    ]
    ...
    const scheme = {
      main: [
        ...
        { id: '2', title: core.lang({ lang: 'add_container'}), type: 'remote', popupid: 'viscont', command: 'addContainer' },
        { id: '3', type: 'divider' }, 
        ...
        { id: '9', type: 'divider' },
        { id: '10', check: 'isSelect', title: core.lang({ lang: 'copy'}), click: this.handleClickCopyElements },
        { id: '11', check: 'isPaste', title: core.lang({ lang: 'paste'}), click: () => this.handleClickPasteElements(e) },
        { id: '12', type: 'divider' },
        { id: '13', check: 'checkCopyStyle', title: core.lang({ lang: 'copy_style'}), click: this.handleCopyStyle},
        { id: '14', check: 'checkPasteStyle', title: core.lang({ lang: 'paste_style'}), click: this.handlePasteStyle },
        { id: '15', type: 'divider' },
        { id: '16', check: 'isSelect', title: core.lang({ lang: 'del'}), click: () => this.handleDeleteElement(elementId) },
        { id: '17', type: 'divider' },
        { id: '19', check: 'isContainer', title: core.lang({ lang: 'edit_container'}), click: this.handleClickEditContainer },
      ]
    }
