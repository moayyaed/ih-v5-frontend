...
class Layout extends PureComponent {
  ...
  componentDidMount() {
    core.actions.form.valueBasic(this.props.id, this.props.options.prop, {
      ...
      columns: {
        s1_c1: { type: null, width: 33.3 },
        s1_c2: { type: null, width: 33.3 },
        s1_c3: { type: null, width: 33.3 },
        s2_c1: { type: null, width: 33.3 },
        s2_c2: { type: null, width: 33.3 },
        s2_c3: { type: null, width: 33.3 },
        s3_c1: { type: null, width: 100 },
        s4_c1: { type: null, width: 33.3 },
        s4_c2: { type: null, width: 33.3 },
        s4_c3: { type: null, width: 33.3 },
      },
