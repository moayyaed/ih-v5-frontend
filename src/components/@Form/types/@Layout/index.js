...
class Layout extends PureComponent {
  ...
  componentDidMount() {
    core.actions.form.valueBasic(this.props.id, this.props.options.prop, {
      ...
      list: ['s1', 's2', 's4'],
      sections: {
        s1: { height: 75, direction: 'row', columns: ['s1_c1', 's1_c2', 's1_c3'] },
        s2: { height: 100, direction: 'row', columns: ['s2_c1', 's2_c2', 's2_c3'] },
        s4: { height: 300, direction: 'column', columns: ['s4_c1', 's4_c2', 's4_c3'] },
      },
      columns: {
        s1_c1: { type: null, size: 33.33 },
        s1_c2: { type: null, size: 33.33 },
        s1_c3: { type: null, size: 33.33 },
        s2_c1: { type: null, size: 33.33 },
        s2_c2: { type: null, size: 33.33 },
        s2_c3: { type: null, size: 33.33 },
        s4_c1: { type: null, size: 33.33 },
        s4_c2: { type: null, size: 33.33 },
        s4_c3: { type: null, size: 33.33 },
      },
