  ...
  handleContextMenuElement = (e, elementId) => {
    ...
    const scheme = {
      main: [
        ...
        { id: '10', type: 'divider' },
        { id: '11', check: 'checkCopyStyle', title: 'Копировать стиль', click: this.handleCopyStyle},
        ...
        { id: '15', type: 'divider' }, 
        { id: '16', check: 'isSelect', title: 'Перепривязать', click: () => this.handleDialogAutoLink(elementId) },
        { id: '17', type: 'divider' }, 
        // { id: '11', type: 'divider' },
