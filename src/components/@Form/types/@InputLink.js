      ...
      if (this.props.route.type) {
        ...
        core.actions.appdialog.data({
          ...
          template: {
            ...
            title: 'Binding Settings',
            type: 'tree',
            id: this.props.route.dialog ? 'elementsAndVistemplate': 'elements',
      ...
      if (prop) {
        ...
        if (obj.error) {
          ...
          try {
            ...
            const params = { ...this.props.data, enabled: true, did, prop, title, template, func, text: this.props.data.value };
